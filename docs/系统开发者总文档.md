...
本系统旨在解决冷链运输与仓储场景下樱桃品质监控难、人工抽检破坏性强、无法实时追踪的问题。通过多光谱传感器与气体传感器融合，结合 MLR（多元线性回归）糖度算法与腐败气体融合算法，实现樱桃糖度与腐败程度的精准无损检测，并将数据上传至云端服务器，最终在 Web 端以可视化大屏呈现，同时支持腐败预警与无人机应急响应。

...
//parameter define
parameter   REG_NUM         =   8'd256      ;   // 【关键】将 251 改成 256
...
assign  cfg_data_reg[251]  =       {16'h4300, 8'h30}; // 格式改为 JPEG
assign  cfg_data_reg[252]  =       {16'h501f, 8'h00}; // ISP 格式配置为 YUV422
assign  cfg_data_reg[253]  =       {16'h4407, 8'h04}; // JPEG 量化压缩倍率
assign  cfg_data_reg[254]  =       {16'h4408, 8'h20}; // JPEG 质量 (0x20适中)
assign  cfg_data_reg[255]  =       {16'h4406, 8'h01}; // 开启 JPEG 引擎
//-------------------------------------------------------
